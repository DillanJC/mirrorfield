"""
Phase D Integrated Evaluation Harness (OPTIMIZED VERSION)

BATCHED EMBEDDINGS for 5-10× speedup over phase_d_integrated_eval.py
...
Key optimization: Batches all unique texts and embeds once, then caches results.
Expected runtime: ~15-20 minutes (vs ~2 hours for original version).

Maintains same outputs as phase_d_integrated_eval.py for verification.
"""
...
from tier2.integrated_eval_fast import (
    run_semantic_mode_fast as run_semantic_mode,
    run_perturbation_mode_fast as run_perturbation_mode,
    run_combined_mode_fast as run_combined_mode,
...
def main():
    parser = argparse.ArgumentParser(description="Phase D: Integrated Evaluation Pipeline (OPTIMIZED)")
    ...
    print("=" * 60)
    print("Phase D: Integrated Evaluation Pipeline (OPTIMIZED)")
    print("=" * 60)
